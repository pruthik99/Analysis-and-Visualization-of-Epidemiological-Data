...
df_school = pd.read_csv('files/vocatinoal_school_data.csv')
...
@callback(
    Output("bar_chart_school1", "figure"),
    [Input("option_value", "value"),
     Input('School_type1', 'value')]
)
...
@callback(
    Output("line_chart_school1", "figure"),
    [Input("option_value", "value"),
     Input('School_type1', 'value')]
)
